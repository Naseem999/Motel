...
<body>
                ...
                <div class="card z-depth-1 cards " style="border-radius: 8px;">
                    <div class="card-content " style="padding: 18px;">
                     ...
                     margin-top: -4em;   box-shadow: 0 4px 20px 0px rgba(0, 0, 0, 0.14), 0 7px 10px -5px rgba(76, 175, 80, 0.4);    border-radius: 5px;">
                        ...
                        <div class="row">
                            <form action="chef/update_chef.php" method="post">
                                <div class="input-field col s12 m12 l12">
                                    <p style="text-align: center;">
                                        <input name="name" placeholder="Name" required type="text" class="validate " style="width: 70%; text-align: left; font-size: 2.5vh;">
                                    </p>
                                </div>
                                <div class="input-field col s12 m12 l12">
                                    <p style="text-align: center;">
                                ...
                                <div class="input-field col s12 m12 l12">
                                    <p style="text-align: center;margin-top: 1em;">
                                        <button name="update_chef_submit" type="submit" class="waves-effect waves-light btn  " style=" background: linear-gradient(60deg, #66bb6a, #43a047); 
    ...
    <?php
        ...
        // echo"<script>window.location.assign('../chef_log.php?error=invalid Access');</script>";
    }
