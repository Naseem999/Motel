        ...
        <div class="col s12 m12 l12">
            ...
            <div class="card z-depth-3 cards " style="border-radius: 8px;">
                <div class="card-content " style="padding: 18px;">
                    <div class="card" style=" padding: 17px;background: linear-gradient(60deg, #ffa726, #fb8c00); 
                     margin-top: -4em;   box-shadow:0 4px 20px 0px rgba(0, 0, 0, 0.14), 0 7px 10px -5px rgba(255, 152, 0, 0.4);   border-radius: 5px;">
                        <div class="card-image white-text cneter-align">
                            ...
                            <p class="valign-wrapper" style=" font-size: 1.8vh;width: 100%; ">
                    ...
                    <!-- <div class="row">
                       <div class="col s12 m12 l12">
                       <a href="admin/notifications.php?del_not=true" style="  text-align: right;  height: 100%; background-color:transparent;   box-shadow: none; ">
                            <i style=" color: gray;" class="right material-icons  ">delete_sweep</i>
                        </a>
                       </div>
                    </div> -->
                    <table>
                        <tbody">
                            <?php
                            $show = false;
                            $sql = "SELECT * FROM notifications WHERE n_for=$chef_id  order by id desc ";
                                    ...
                                    <tr>
                                        ...
                                        <div class="valign-wrapper card-panel hoverable  " style=" border: 1px solid #dedede; padding: 0px;">
                                            ...
                                            <div class="col s3  m1 l1 waves-effect   waves-red " style=" height: 9vh;  ">
                                                <form action="chef/del_not.php" method="get">
