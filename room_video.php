        ...
        <div class="parallax-container">
            ...
            <div class="row z-depth-5 center-align " style=" height: 100%; background: linear-gradient(180deg, rgba(250,222,231,0.0) 10%, rgba(0,0,0,0.9) 100%); ">
                <div class="col s12 m12 l12 center-align" style=" height: 100%;">
                    <p class="price_title">120<span style="font-size: 10vh; vertical-align: top;">$</span></p>
    ...
    <div class="row header_row">
        <div class="row">
            ...
            <P style="font-family: 'Poppins', sans-serif; color: #727475; font-size: 6.5vh;;margin-bottom: 0px; margin-top: 0px; font-weight: lighter;">
                Room with View</P>
            <span style="font-family: 'Poppins', sans-serif; color: #a3a3a3; letter-spacing:2px; font-size: 2.2vh; margin-top: 0px;">HOTEL LONDON</span>
        ...
        <div class="row">
            <div class="col s12 m8 l8">
                ...
                <?php
                if (isset($img)) {
                    echo "<div class='col s12 m12 l12 ' style=' height: 60vh;
                    background: url($room_img) no-repeat 50% 50%;
                    background-size: cover;
                    '></div>";
                } else {
                   ?>
                    <video  class="responsive-video z-depth-2  " autoplay muted loop  >
                        <source src="img/Room-1.m4v" type="video/mp4">
                    </video>
                    <?php
                }
                ?>
    ...
    <?php
       ...
       ?>
            ...
            <div class="col s12 m12 l12 center-align" style=" background-color:#3a3a3a; ">
                    ...
                    <input name="room_img" type="hidden" value="h7_s_card_6.jpg">
                    <input name="room_price" type="hidden" value="120">  
                    <input name="room_name" type="hidden" value="Room with View">  
                    ...
                    <div class="card-action" style="background-color: #3a3a3a; ">
                            <div class="row" style="background-color: #1c1c1c;">
                                ...
                                <div class="col s6 m6 l6">
                                    ...
                                    <Input min ="4" max="4"  name="guest" type="number" style="margin-top: 10px; width: 50%; border: none;  color: wheat; text-align: center; font-size:6vh" placeholder="4">
                                </div>
                                <div class="col s6 m6 l6" style="background-color: #838485;">
