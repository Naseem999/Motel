...
<body>
    ...
    if (!empty($_SESSION['shopping_cart'])) {
        ...
        if (isset($_POST['order'])) {
            foreach ($_SESSION["shopping_cart"] as $keys => $values) {
                ...
                $sql2 = "INSERT INTO orders(item_name,item_img,item_price,item_quantity,item_type,item_status,table_no,chef,timestamp_) VALUES('$item_name','$item_img','$item_price','$item_quantity','$item_type','$status','$table_no','$chef',now())";
                mysqli_query($con, $sql2);
                

                $title = "New Order :" . $item_name . " on Table No :" . $table_no;
            ...
            echo "<script>window.location.replace('order_processing.php');</script>";
        }
        ...
        <div class="row main_row">
                    ...
                    ?>
                            ...
                            <div class="col s12 m12 l12">
                                ...
                                <form action="cart_sys/update_quantity.php" method="post">
                                    ...
                                    <div id="<?php echo $item_name; ?>" class="modal bottom-sheet" style="  background-color: rgba(0,0,0,0.5); backdrop-filter: blur(20px)">
            ...
            <div class="col s12 m8 l8">
                ...
                <div class="col s12 m8 l8 " style="margin-top: 20px; margin-bottom: 20px;">
                    <a href="#checkout" class="btn-large waves-effect waves-light  modal-trigger " type="submit" style=" width: 100%;  background-color: #ea4e60; border-radius: 5px; font-weight: 600;" name="action">Checkout
                    </a>
                </div>
            </div>
        </div>

        <div id="checkout" class="modal" style="height: 80vh; background-color: rgba(0,0,0,0.2); border-radius: 10px; backdrop-filter: blur(6px);">
            <div class="modal-content">
                ...
                <div class="row">
                    <div class="col s12 m12 l12 center-align">
                        <form action="checkout_guest.php" method="post">
                            ...
                            <button type="submit" name="order" class="waves-effect waves-light btn-large" style=" width: 100%; background-color: #1c1c1c; border-radius:5px;">
                                Proceed</button>
                        </form>
                    </div>
                </div>
    ...
    <?php
        ...
        print "<script>window.location.assign('menu.php')</script>"; // Prompts the user
    }
    ?>
</body>
