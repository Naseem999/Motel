...
<body>
    ...
    if(isset($_GET['room_type']) && isset($_GET['room_price']) && $_GET['room_guest'] && $_GET['room_feet'] ){
        ...
        $room_guest=mysqli_real_escape_string($con,$_GET['room_guest']);
        $room_guest=mysqli_real_escape_string($con,$_GET['room_feet']);

        echo $img." ".$room_type." ".$room_price;
    }
    ?>
    ...
    <?php
       ...
       ?>
            ...
            <div class="col s12 m12 l12 center-align" style=" background-color:#3a3a3a; ">
                    ...
                    <input name="room_img" type="hidden" value="h7_s_card_4.jpg">
                    <input name="room_price" type="hidden" value="80">  
                    <input name="room_name" type="hidden" value="Apartment">  
                    ...
                    <div class="card-action" style="background-color: #3a3a3a; ">
                            <div class="row" style="background-color: #1c1c1c;">
                                ...
                                <div class="col s6 m6 l6">
                                    ...
                                    <Input min ="5" max="5" value="1" name="guest" type="number" style="margin-top: 10px; width: 50%; border: none;  color: wheat; text-align: center; font-size:6vh" placeholder="5">
                                </div>
                                <div class="col s6 m6 l6" style="background-color: #838485;">
