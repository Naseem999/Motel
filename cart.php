            ...
            <tbody">
                ...
                ?>
                    ...
                    <p style="text-align: center;">
                     ...
                     ><img class="responsive-img" style="height: 60vh;" src="img/undraw_add_to_cart_vkjp.svg">
                     </a>
                    </p>
                    <?php
                } else {
                        ...
                        <tr>
                            ...
                            <div class="valign-wrapper card-panel hoverable  " style="border: 1px solid #dedede; padding: 0px;">
                                ...
                                <div class="col s3  m1 l1 waves-effect   waves-red " style=" height: 9vh;  ">
                                    <form action="cart_sys/del_item.php" method="post">
                                        <input name="item_id" type="hidden" value="<?php echo $row['id'] ?>">
                                        <button class="left" type="submit" name="del_item_submit" 
                                        style="text-align: left; height: 100%; border:none; background-color:transparent; cursor: pointer;  box-shadow: none; ">
...
<?php
    ...
    header("Location:cart_guest.php");
}
?>
<script>
