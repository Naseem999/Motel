<div class="row center-align">
    ...
    <hr style="width: 40px;">
    <h1 style="color: #727475;font-size: 8vh; margin-top: 20px;">Non-Veg Menu</h1>
        ...
        <div class="col s12 m4 l4">
            <div class="valign-wrapper card-panel grey lighten-5 z-depth-3 " style="padding: 0px; border-radius: 10px;">
                ...
                <div class="col s8 m12 l12">
                    ...
                    <a class="waves-effect waves-light  modal-trigger" href="#<?php echo $row['id']; ?>" style=" padding: 0px;  border: none; background-color: transparent; box-shadow: none;"><span style="background-color: #B22222;  color:#f6f6f6; padding:2px;">order now</span></a>
