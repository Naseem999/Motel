...
<body>
    ...
    <div class="row">
        <?php
        $sql1 = "SELECT * FROM todo WHERE note_for=$admin_id order by id desc";
            ...
            ?>
                    ...
                    <div class="card z-depth-1 " style="border-radius: 10px;">
                        <div class="card-content black-text">
                            ...
                            <div class="row" style="margin-bottom: 0px;">
                                ...
                                <div class="col s6 m6 l6 ">
                                    <a href="admin/crud_note.php?del_id=<?php echo $row1['id']; ?>" class="right " style="  text-align: left; margin-left: 1.6em; height: 100%; background-color:transparent;   box-shadow: none; ">
                ...
                <div id="<?php echo "note" . $row1['id']; ?>" class="modal md" style="border-radius: 10px;">
                    <div class="modal-content">
                        <form action="admin/crud_note.php" method="post">
