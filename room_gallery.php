...
<head>
    ...
    ?>
    <title>Motel-Room Gallery</title>
</head>
...
<body>
        ...
        <div class="parallax-container">
            ...
            <div class="row z-depth-5 center-align " style=" height: 100%; background: linear-gradient(180deg, rgba(250,222,231,0.0) 10%, rgba(0,0,0,0.9) 100%); ">
                <div class="col s12 m12 l12 center-align" style=" height: 100%;">
                    <p style="word-wrap: break-word;color: wheat; margin-bottom: 0px; font-size: 15em; margin-top: 0vh;font-family: Copperplate, Papyrus, fantasy;">30<span style="font-size: 10vh; vertical-align: top;">$</span></p>
    ...
    <div class="row header_row">
        <div class="row">
            ...
            <P style="font-family: 'Poppins', sans-serif; color: #727475; font-size: 6.5vh;;margin-bottom: 0px; margin-top: 0px; font-weight: lighter;">Small Room</P>
            <span style="font-family: 'Poppins', sans-serif; color: #a3a3a3; letter-spacing:2px; font-size: 2.2vh; margin-top: 0px;">HOTEL ROME</span>
        ...
        <div class="row">
            <div class="col s12 m8 l8">
                <div class="row">
                    <div class="carousel carousel-slider" style="height: 60vh;">
                       ...
                       background: url(img/h5_header_2.jpg) no-repeat 50% 50%;
                       background-size: cover;
                        cursor:grabbing;">
                        </div>
                        <div class=" carousel-item fadeIn " style="  width: 100%;
 
                         background: url(img/h7_parllax_bg3.jpg) no-repeat 50% 50%  ;
                         background-size: cover;
                          cursor:grabbing;">
                        </div>
                        <div class=" carousel-item fadeIn" style=" width: 100%;
                ...
                <div class="row">
                    ...
                    <?php include_once 'partial/price_cal.php'; ?>
                    </div>"></i>
                ...
                <div class="row" style="margin-top: 5vh;">
                    ...
                    <div class="col s12 m4 l4 ">
                        <i style="color: #a3a3a3;margin: 10px;" class="fas fa-smoking-ban fa-2x"></i>
                        <span style="color: #a3a3a3; font-size:2.5vh; font-weight: lighter; ">
                            No Smoking</span>
                    </div>
                    <div class="col s12 m4 l4 ">
            ...
            <div class="col s12 m4 l4">
                <div class="col s12 m12 l12 center-align" style=" background-color:#3a3a3a; ">
                    ...
                    <input name="room_img" type="hidden" value="h5_big_card.jpg">
                    <input name="room_price" type="hidden" value="30">  
                    <input name="room_name" type="hidden" value="Small Room">  
                    ...
                    <div class="card-action" style="background-color: #3a3a3a; ">
                            <div class="row" style="background-color: #1c1c1c;">
                                ...
                                <div class="col s6 m6 l6">
                                    ...
                                    <Input min ="1" max="1" value="1" name="guest" type="number" style="margin-top: 10px; width: 50%; border: none;  color: wheat; text-align: center; font-size:6vh" placeholder="1">
                                </div>
                                <div class="col s6 m6 l6" style="background-color: #838485;">
